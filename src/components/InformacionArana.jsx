...
export const InformacionArana = () => {
  ...
  const filteredArachnids = (arachnids) => {
    return arachnids.filter(arachnid => arachnid.title.toLowerCase().includes(filter.toLowerCase()));
  };
  ...
  return (
    <>
      ...
      <Row xs={1} md={4} className="g-4 justify-content-center">
        {filteredArachnids(aranas).map((spider, index) => (
                ...
                <Modal show={show[spider.id]} onHide={() => handleClose(spider.id)} centered>
                  ...
                  <Modal.Body>
                    <div className="mt-2 mb-2 ms-2 me-2">
                      <Row>
                        <Col>
                          <img src={spider.modalImg} className="img-fluid" alt="Modal Visual" />
                        </Col>
                        <Col>
                          <p className="text-end">{spider.descriptionShort}</p>
                        </Col>
                      </Row>
                      <Row>
                        <Col>
                          <p className="text-center">{spider.descriptionLong}</p>
                          <br /><p><i><font color="gray">{spider.source}</font></i></p>
                        </Col>
                      </Row>
                    </div>
                  </Modal.Body>
                  <Modal.Footer>
                    <Button variant="secondary" onClick={() => handleClose(spider.id)}>Regresar</Button>
                  </Modal.Footer>
                </Modal>
              </Card.ImgOverlay>
            </Card>
      ...
      <Row xs={1} md={4} className="g-4 justify-content-center">
        {filteredArachnids(alacranes).map((scorpion, index) => (
                ...
                <Modal show={show[scorpion.id]} onHide={() => handleClose(scorpion.id)} centered>
                  ...
                  <Modal.Body>
                    <div className="mt-2 mb-2 ms-2 me-2">
                      <Row>
                        <Col>
                          <img src={scorpion.modalImg} className="img-fluid" alt="Modal Visual" />
                        </Col>
                        <Col>
                          <p className="text-end">{scorpion.descriptionShort}</p>
                        </Col>
                      </Row>
                      <Row>
                        <Col>
                          <p className="text-center">{scorpion.descriptionLong}</p>
                          <br /><p><i><font color="gray">{scorpion.source}</font></i></p>
                        </Col>
                      </Row>
                    </div>
                  </Modal.Body>
                  <Modal.Footer>
                    <Button variant="secondary" onClick={() => handleClose(scorpion.id)}>Regresar</Button>
                  </Modal.Footer>
                </Modal>
              </Card.ImgOverlay>
            </Card>
